    ...
    return (
        <section className=''>
            <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 ">
                <div className="xl:mx-auto border border-stone-950 shadow-sm py-5 px-20 rounded-md xl:w-full xl:max-w-sm 2xl:max-w-md">
                    ...
                    <h2 className="text-center text-2xl font-bold leading-tight text-blue-800">
                    ...
                    <p className="mt-2 text-center text-base text-gray-600">
                        ...
                        <Link to="/login"
                            href="#"
                            title=""
                            className="font-medium text-red-600 font-extrabold  transition-all duration-200 hover:underline"
                        >
                            Sign In
                        </Link>
                    </p>
                    <form action="#" method="POST" className="mt-8" onSubmit={registerSubmit}>
                        <div className="space-y-5">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="inline-flex w-full items-center justify-center rounded-md bg-blue-600 px-3.5 py-2.5 font-semibold leading-7 text-white hover:text-black hover:bg-blue-400"
                                >
